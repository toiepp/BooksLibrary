...
import static ru.bookslibrary.web.rest.AccountControllerIT.TEST_USER_LOGIN;
...
import ru.bookslibrary.config.Constants;
import ru.bookslibrary.domain.User;
import ru.bookslibrary.repository.AuthorityRepository;
import ru.bookslibrary.repository.UserRepository;
import ru.bookslibrary.security.AuthoritiesConstants;
import ru.bookslibrary.service.UserService;
import ru.bookslibrary.service.dto.AdminUserDTO;
import ru.bookslibrary.service.dto.PasswordChangeDTO;
import ru.bookslibrary.web.rest.vm.KeyAndPasswordVM;
import ru.bookslibrary.web.rest.vm.ManagedUserVM;
...
class AccountControllerIT {
    ...
    void testRegisterValid() throws Exception {
        ...
        validUser.setFio("Alice");
        validUser.setAddress("Test");
        validUser.setEmail("test-register-valid@example.com");
        validUser.setImageUrl("http://placehold.it/50x50");
        validUser.setLangKey(Constants.DEFAULT_LANGUAGE);
        validUser.setAuthorities(Collections.singleton(AuthoritiesConstants.EMPLOYEE));
    ...
    void testRegisterInvalidLogin() throws Exception {
        ...
        invalidUser.setFio("Funky");
        invalidUser.setAddress("One");
        invalidUser.setEmail("funky@example.com");
        invalidUser.setActivated(true);
        invalidUser.setImageUrl("http://placehold.it/50x50");
        invalidUser.setLangKey(Constants.DEFAULT_LANGUAGE);
        invalidUser.setAuthorities(Collections.singleton(AuthoritiesConstants.EMPLOYEE));
    ...
    void testRegisterInvalidEmail() throws Exception {
        ...
        invalidUser.setPassword("password");
        invalidUser.setFio("Bob");
        invalidUser.setAddress("Green");
    ...
    void testRegisterDuplicateLogin() throws Exception {
        ...
        firstUser.setFio("Alice");
        firstUser.setAddress("Something");
        firstUser.setEmail("alice@example.com");
        firstUser.setImageUrl("http://placehold.it/50x50");
        firstUser.setLangKey(Constants.DEFAULT_LANGUAGE);
        firstUser.setAuthorities(Collections.singleton(AuthoritiesConstants.EMPLOYEE));

        // Duplicate login, different email
        ManagedUserVM secondUser = new ManagedUserVM();
        secondUser.setLogin(firstUser.getLogin());
        secondUser.setPassword(firstUser.getPassword());
        secondUser.setFio(firstUser.getFio());
        secondUser.setAddress(firstUser.getAddress());
    ...
    void testRegisterDuplicateEmail() throws Exception {
        ...
        userWithUpperCaseEmail.setFio(firstUser.getFio());
        userWithUpperCaseEmail.setAddress(firstUser.getAddress());
    ...
    void testRegisterAdminIsIgnored() throws Exception {
        ...
        validUser.setPassword("password");
        validUser.setFio("Bad");
        validUser.setAddress("Guy");
        ...
        assertThat(userDup.get().getAuthorities())
            .hasSize(1)
            .containsExactly(authorityRepository.findById(AuthoritiesConstants.EMPLOYEE).get());
    }
    ...
    void testSaveAccount() throws Exception {
        ...
        userDTO.setFio("firstname");
        userDTO.setAddress("lastname");
        ...
        assertThat(updatedUser.getFio()).isEqualTo(userDTO.getFio());
